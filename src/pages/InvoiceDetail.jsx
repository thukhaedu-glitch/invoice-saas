...
<div>
<div style={{fontWeight:700,fontSize:22}}>{company?.name||'Company'}</div>
<div style={{fontSize:12,opacity:0.8,marginTop:2}}>Invoice SaaS</div>
</div>
</div>
...
{/* Bill To */}
<div style={{marginTop:24,paddingTop:20,borderTop:'0.5px solid rgba(255,255,255,0.2)',display:'flex',justifyContent:'space-between'}}>
<div>
<div style={{fontSize:10,opacity:0.7,marginBottom:4,textTransform:'uppercase',letterSpacing:'0.05em'}}>Bill To</div>
...
{invoice.clientAddress&&<div style={{fontSize:12,opacity:0.8}}>{invoice.clientAddress}</div>}
</div>
<div style={{textAlign:'right'}}>
<div style={{fontSize:10,opacity:0.7,marginBottom:4,textTransform:'uppercase',letterSpacing:'0.05em'}}>Date</div>
...
{/* Totals + QR */}
<div style={{padding:'24px 40px',borderBottom:'0.5px solid #f1f5f9',display:'flex',justifyContent:'space-between',alignItems:'flex-end'}}>
{/* QR Code */}
{settings.showQR&&(
...
<div style={{fontSize:11,color:'#9aa0b4'}}>SEC: {invoice.securityCode}</div>
</div>
</div>
</div>
</>
