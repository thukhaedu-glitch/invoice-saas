...
<input value={pass} onChange={e=>setPass(e.target.value)} type={showPass?'text':'password'} required placeholder="Min 6 characters" className="form-input" style={{paddingLeft:34,paddingRight:36}}/>
...
<div style={{position:'relative'}}>
<Building2 size={14} style={{position:'absolute',left:11,top:'50%',transform:'translateY(-50%)',color:'var(--text-3)'}}/>
